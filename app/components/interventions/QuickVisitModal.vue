<template>
  <Teleport to="body">
    <Transition name="modal">
      ...
      >
        <div
          class="flex h-full w-full flex-col overflow-hidden lg:max-h-[90dvh] lg:max-w-xl lg:rounded-[20px] lg:shadow-2xl"
        >
          ...
          >
            <div>
              <h2 class="text-[16px] font-semibold" style="color: var(--text-primary)">
                Visite rapide · {{ rucherNom }}
              </h2>
            ...
            <button
              aria-label="Fermer"
              type="button"
              class="flex h-8 w-8 items-center justify-center rounded-[8px] transition-colors hover:bg-[var(--surface-muted)]"
          ...
          <div class="app-content flex-1 overflow-y-auto px-5 py-5">
            <InterventionsVisiteRucherForm ref="formRef" :ruches="ruches" />
          </div>
          ...
          <div
            ...
            style="
              ...
              background: white;
              padding-bottom: max(1rem, constant(safe-area-inset-bottom, 0px));
