...
export const MEDICAMENTS_APICOLES: MedicamentApicole[] = [
  ...
  { nom: 'Apilife Var', substance: 'Thymol/Camphre/Eucalyptol/Menthol', delaiAttenteJours: 0, indication: 'Varroase' },
  { nom: 'MAQS', substance: 'Acide formique', delaiAttenteJours: 0, indication: 'Varroase' },
  { nom: 'VarroMed', substance: 'Acide oxalique/formique', delaiAttenteJours: 0, indication: 'Varroase' },
