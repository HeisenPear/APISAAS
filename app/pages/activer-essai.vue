<template>
  <div class="flex min-h-dvh items-center justify-center p-4 py-10" style="background:var(--surface-primary)">
    <div class="w-full max-w-lg space-y-6">
      ...
      <!-- Card principale -->
      <div class="rounded-[20px] border bg-white shadow-sm overflow-hidden" style="border-color:var(--border-default)">

        <!-- Bandeau top honey -->
        <div class="px-8 py-5 text-center" style="background:linear-gradient(135deg,var(--honey) 0%,var(--honey-dark) 100%)">
          <div class="inline-flex items-center gap-2 rounded-full bg-white/20 px-4 py-1.5 text-[13px] font-semibold text-white mb-3">
        ...
        <div class="p-8">
          ...
          <div v-if="trialAlreadyUsed" class="text-center py-4">
            ...
            <h2 class="text-[20px] font-bold tracking-[-0.02em] mb-2" style="color:var(--text-primary)">Essai déjà activé</h2>
          ...
          <template v-else>
            ...
            <!-- Timeline rassurante -->
            <div class="mb-7">
              <p class="text-[11px] font-semibold uppercase tracking-[0.1em] mb-3" style="color:var(--honey-deep)">Comment ça marche</p>
              <div class="flex items-start gap-0">
                <!-- Étape 1 -->
                <div class="flex-1 text-center">
                  <div class="mx-auto mb-2 flex h-9 w-9 items-center justify-center rounded-full text-white text-sm font-bold" style="background:var(--honey)">1</div>
                  <p class="text-[12px] font-semibold" style="color:var(--text-primary)">Aujourd'hui</p>
                  <p class="text-[11px] leading-snug mt-0.5" style="color:var(--text-tertiary)">Carte enregistrée<br>0 € prélevé</p>
                </div>
                <!-- Trait -->
                <div class="mt-4.5 flex-1 border-t-2 border-dashed" style="border-color:var(--border-default)" />
                <!-- Étape 2 -->
                <div class="flex-1 text-center">
                  <div class="mx-auto mb-2 flex h-9 w-9 items-center justify-center rounded-full text-[13px] font-bold" style="background:var(--honey-soft);color:var(--honey-deep)">2</div>
                  <p class="text-[12px] font-semibold" style="color:var(--text-primary)">J-7</p>
                  <p class="text-[11px] leading-snug mt-0.5" style="color:var(--text-tertiary)">Email de rappel<br>Annulez si besoin</p>
                </div>
                <!-- Trait -->
                <div class="mt-4.5 flex-1 border-t-2 border-dashed" style="border-color:var(--border-default)" />
                <!-- Étape 3 -->
                <div class="flex-1 text-center">
                  <div class="mx-auto mb-2 flex h-9 w-9 items-center justify-center rounded-full text-[13px] font-bold" style="background:var(--surface-muted);color:var(--text-tertiary)">3</div>
                  <p class="text-[12px] font-semibold" style="color:var(--text-primary)">Jour 60</p>
                  <p class="text-[11px] leading-snug mt-0.5" style="color:var(--text-tertiary)">14,99 €/mois<br>si vous continuez</p>
                </div>
              </div>
            </div>
            ...
            <!-- Features incluses -->
            <div class="mb-6">
              <p class="text-[11px] font-semibold uppercase tracking-[0.1em] mb-3" style="color:var(--honey-deep)">Tout le plan Pro débloqué</p>
              <ul class="space-y-2">
            ...
            <div class="mb-6 flex gap-3 rounded-[12px] border px-4 py-3.5" style="background:var(--honey-soft);border-color:rgba(245,166,35,0.2)">
              <UIcon name="i-lucide-lock" class="h-4 w-4 shrink-0 mt-0.5" style="color:var(--honey-dark)" />
              <p class="text-[12.5px] leading-relaxed" style="color:var(--honey-deep)">
                <strong>Pourquoi votre carte ?</strong> Elle sécurise votre compte et permet la continuité du service après l'essai — vous ne serez débité que dans 60 jours, et seulement si vous choisissez de rester.
              </p>
            </div>
      ...
      <div class="flex flex-wrap items-center justify-center gap-x-5 gap-y-2">
        <div v-for="proof in proofs" :key="proof.label" class="flex items-center gap-1.5 text-[12px]" style="color:var(--text-tertiary)">
