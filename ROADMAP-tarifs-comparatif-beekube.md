...
| **Expert** | 🏢 **Gestion multi-sites** _(décidé : multi-SIRET + regroupement géo — voir §6)_ | ❌ Absent en tant que tel (les ruchers sont déjà illimités)                                                              | Niveau d'organisation **au-dessus du rucher** pour les grosses exploitations / structures multi-lieux. Retenu : multi-établissements (SIRET) + regroupement géographique des ruchers (cf. §6)                                  | Moyen→élevé selon l'option                                                    |
...
| **Assistant IA** : conseils contextuels                      |                    ✅ (Premium)                     |                     ❌                     | Écart              | **→ Maya (cf. MAYA.md)**                                   |
